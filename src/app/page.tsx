      ...
      <div className="mx-auto  w-[95vw] sm:w-[85vw]  space-y-16 pb-20">
        <div className="space-y-10  ">
          ...
          <div className=" space-y-4 text-justify *:text-[18px] *:opacity-80">
            <p className="">
              Hello, I am <span className="font-bold">Ömer Faruk Boran</span>. I
              was born in Şanlıurfa and I am continuing my education in Konya. I
              work as a Full Stack Developer with experience in both front-end
              and back-end development. Currently, I am in the process of
